...
void searchByFriend(HashFriend& hf, int id)
{
	...
	{
		if(!userID[id].getFriend().isEmpty() && userID[id].getFriend().linearSearch(firstN + " " + lastN) != -1) // verify whether the user is your friend already
		{
